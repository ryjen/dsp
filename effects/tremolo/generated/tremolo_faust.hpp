...
Compilation options: -a faust/architectures/standalone-header.cpp -lang cpp -i -inpl -fpga-mem-th 4 -light -nvi -ct 1 -cn TremoloFaust -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class TremoloFaust final : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a faust/architectures/standalone-header.cpp -lang cpp -i -inpl -fpga-mem-th 4 -light -nvi -ct 1 -cn TremoloFaust -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
